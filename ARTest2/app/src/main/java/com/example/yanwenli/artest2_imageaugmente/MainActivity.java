...
//                    SnackbarHelper.getInstance().showMessage(this, text);
                ...
                case TRACKING:
                    ...
                    if (!augmentedImageMap.containsKey(augmentedImage)) {
                        ...
                        if(!augmentedImageMap.isEmpty()) {
//                            augmentedImageMap.get(augmentedImage).setOnTapListener((HitTestResult hitTestResult, MotionEvent motionEvent) -> {
//
...
//                            });
                            ...
                            augmentedImageMap.get(augmentedImage).setOnTouchListener(new Node.OnTouchListener() {
                                @Override
